...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, cakeBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold CGC'),
      bodyText: [t('Each NFT costs CGC to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://pancakeswap.finance/swap?outputCurrency=0xCb597f83722fC551e0748b25B2a0ac613606bb62"
            target="_blank"
            width="100%"
          >
            {t('Buy CGC')}
